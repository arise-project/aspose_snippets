...
class pdf_to_png(object):
    ...
    def exec(self):
        ...
        for pageCount in range(1, doc.Pages.Count):
            ...
            imageDevice = PngDevice(doc.Pages[pageCount].PageInfo.Width, doc.Pages[pageCount].PageInfo.Height, resolution)
        ...
        fileSource = FileCreateSource("./test.png", False) #preserve image on the disk
