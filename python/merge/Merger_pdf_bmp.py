...
class pdf_to_bmp(object):
    ...
    def exec(self):
        ...
        for pageCount in range(1, doc.Pages.Count):
            ...
            imageDevice = BmpDevice(doc.Pages[pageCount].PageInfo.Width, doc.Pages[pageCount].PageInfo.Height, resolution)
        ...
        fileSource = FileCreateSource("./test.bmp", false) #preserve image on the disk
