    ...
    public static partial class Merger
    {
        public static void pdf_to_bmp()
        {
            ...
            for (int pageCount = 1; pageCount <= doc.Pages.Count; pageCount++)
            {
                ...
                var imageDevice = new Aspose.Pdf.Devices.BmpDevice((int)doc.Pages[pageCount].PageInfo.Width, (int)doc.Pages[pageCount].PageInfo.Height, resolution);
            ...
            Aspose.Imaging.Source fileSource = new Aspose.Imaging.Sources.FileCreateSource("./test.bmp", isTemporal: false);
            var options = new Aspose.Imaging.ImageOptions.BmpOptions() { Source = fileSource };
